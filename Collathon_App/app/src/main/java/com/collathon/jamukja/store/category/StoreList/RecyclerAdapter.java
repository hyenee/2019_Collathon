package com.collathon.jamukja.store.category.StoreList;
...
import com.collathon.jamukja.store.StoreDetailActivity;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_store_item_view, parent, false);
